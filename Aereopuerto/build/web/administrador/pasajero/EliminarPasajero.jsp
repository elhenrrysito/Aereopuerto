<%-- 
    ...
    Created on : 24-may-2021, 12:15:43
    Author     : henrr
--%>
...
<html>
    ...
    <body>
        <%
            String rut = request.getParameter("pasaporte_pasajero");
            PasajeroDAO pasajeroDAO = new PasajeroDAO();
            Pasajero pasajero = pasajeroDAO.buscar(rut);
        ...
        <div class="container w-50 bg-white rounded shadow mt-4 mb-4">
            <div class="row align-items-stretch">
                <div class="col bg">
                    ...
                    <h1 class="text-center mb-4">Eliminar Pasajero</h1>
