...
$(document).ready(function () {
    $("#insertar_usuarios").click(function (event) {
        $("#cargarPagina").load('usuario/insertarUsuario.jsp');
    });
    // usuarios
    $("#listar_usuarios").click(function (event) {
        $("#cargarPagina").load('usuario/listarUsuarios.jsp');
    });
