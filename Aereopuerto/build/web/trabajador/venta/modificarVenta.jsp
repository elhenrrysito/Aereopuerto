<%-- 
    ...
    Created on : 27-may-2021, 21:48:17
    Author     : henrr
--%>
        ...
        <div class="container w-50 bg-white rounded shadow mt-4 mb-4">
            <div class="row align-items-stretch">
                <div class="col bg">
                    ...
                    <h1 class="text-center mb-4">Modificar Venta</h1>
                    <form class="row g-3" action="../../ControladorVentaTrabajador" method="POST">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="fecha_venta" value="<%=venta.getFecha()%>">
                        </div>
