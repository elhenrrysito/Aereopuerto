                ...
                <tbody>
                    <%
                        ...
                        for (Venta obj : VentaDAO.obtenerDatos()) {
                            ...
                            out.println("<td><a href=../trabajador/venta/eliminarVenta.jsp?codigo_venta=" + obj.getCodigo() + " id='eliminar_venta'>Eliminar</a></td>");
                            out.println("<td><a href=../trabajador/venta/modificarVenta.jsp?codigo_venta=" + obj.getCodigo() + " id='modificar_venta'>Modificar</a></td>");
                            out.println("<tr>");
                            contador++;
                        }
                    %>
