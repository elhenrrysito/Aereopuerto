<%-- 
    Document   : form_trabajador
    Created on : May 21, 2021, 4:38:32 PM
    Author     : henrry
--%>
...
<html>
    <head>
        ...
        <script src="../js/JQueryLoadTrabajador.js"></script>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../trabajador/form_trabajador.jsp">Inicio</a>
                        </li>
